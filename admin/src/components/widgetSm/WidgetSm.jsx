        ...
        const res = await axios.get("/users?new=true", {
          headers: {
            token:
              ...
              "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxMGVkNTQyZWI0YjQyNTJjOGI3OTQwNSIsImlzQWRtaW4iOnRydWUsImlhdCI6MTYyNTgzMjMxMSwiZXhwIjoxNzI3MjY0MzExfQ.9okmmXwad3BD8sYkThnB2r198PDUzbrbd4TOvJUuQm4",
          },
        });
